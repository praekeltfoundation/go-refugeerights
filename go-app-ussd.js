        ...
        self.add('state_migrant_main', function(name) {
            return new PaginatedChoiceState(name, {
                ...
                choices: [
                    ...
                    new Choice('state_072', $('Tips')),
                    new Choice('state_073', $('Word definitions')),
                    new Choice('state_074', $('More word definitions')),
                    new Choice('state_075', $('Useful contacts')),
                    new Choice('state_076', $('Change settings')),
                    new Choice('state_077', $('Ts & Cs of this service')),
